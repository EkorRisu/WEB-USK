...
<body class="min-h-screen font-sans antialiased">
    <div id="app">
        ...
        <nav class="bg-gray-200 dark:bg-black fixed top-0 left-0 w-full z-50 shadow dark:shadow-gray-700" x-data="{ isOpen: false }">
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div class="flex justify-between h-20 items-center">
                    <a href="{{ url('/admin/dashboard') }}" class="text-black dark:text-white font-bold text-lg">
                        AzurBook Store ( {{ Auth::user()->name ?? 'Admin' }} )
                    </a>

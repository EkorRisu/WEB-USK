...
<div class="bg-yellow-50 dark:bg-gray-900 min-h-screen p-6">
    <div class="max-w-2xl mx-auto">
        ...
        <div class="bg-yellow-100 dark:bg-gray-800 rounded-lg p-6 mb-6 border border-yellow-200 dark:border-gray-700">
            <h1 class="text-3xl font-bold text-yellow-900 dark:text-yellow-100 mb-2">✏️ Edit Topping</h1>
            <p class="text-yellow-700 dark:text-yellow-300">Ubah informasi topping: {{ $topping->name }}</p>
        </div>
